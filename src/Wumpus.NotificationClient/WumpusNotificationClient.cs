...
namespace Wumpus.NotificationClient;

public class WumpusNotificationClient : IDisposable
{
    ...
    /// </summary>
    /// <param name="baseUrl">Base URL of the Wumpus Intake API (e.g., "http://localhost:1973")</param>
    /// <param name="httpClient">Optional HttpClient to use. If not provided, a new one will be created.</param>
    public WumpusNotificationClient(string baseUrl, HttpClient? httpClient = null)
    {
