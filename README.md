...
- **Intake API** (Port 5000) - Receives and processes crash reports
- **Web UI** (Port 5001) - Dashboard for viewing crashes
...
2. **Access the services:**
   ...
   - Intake API: http://localhost:5000
...
```
POST http://localhost:5000/api/v1/crashes
...
```bash
curl -X POST http://localhost:5000/api/v1/crashes \\
...
- Intake API: http://localhost:5000/health
- Web UI: http://localhost:5001/health
...
```yaml
ports:
  - "5010:5000"  # Change left side only
```
